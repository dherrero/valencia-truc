...
export const translations: Record<Language, TranslationTree> = {
  ca: {
    ...
    board: {
      ...
      rotateDeviceTitle: 'Només mode vertical',
      rotateDeviceText: 'Gira el dispositiu per a jugar al Truc.',
  ...
  es: {
    ...
    board: {
      ...
      rotateDeviceTitle: 'Sólo modo vertical',
      rotateDeviceText: 'Gira tu dispositivo para jugar al Truc.',
